...
define i32 @result_test(i32 %0, i8** %1) {
  %3 = call i32 @__quantum__rt__initialize(i32 %0, i8** %1)
  %4 = call i32 @__internal_mlir_QCOR_Compatible_B-V_transpiled_Superconducting_qc3()
  call void @__quantum__rt__finalize()
  ret i32 %4
}

define i32 @__internal_mlir_QCOR_Compatible_B-V_transpiled_Superconducting_qc3() {
...
define i32 @QCOR_Compatible_B-V_transpiled_Superconducting_qc3(%qreg* %0) {
  call void @__quantum__rt__set_external_qreg(%qreg* %0)
  %2 = call i32 @__internal_mlir_QCOR_Compatible_B-V_transpiled_Superconducting_qc3()
  call void @__quantum__rt__finalize()
  ret i32 %2
}
