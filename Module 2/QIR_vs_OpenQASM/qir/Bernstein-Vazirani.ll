...
entry:
  ...
  call void @Microsoft__Quantum__Canon___cc9918f8954448c191d048b07b6bc3c9_ApplyToEachA__body(%Callable* %0, %Array* %queryRegister)
  ...
  call void @Microsoft__Quantum__Canon___cc9918f8954448c191d048b07b6bc3c9_ApplyToEachA__adj(%Callable* %5, %Array* %queryRegister)
  ...
  %resultArray = call %Array* @Microsoft__Quantum__Arrays___0d57dd9cd09e4096927dde82c89cb683_ForEach__body(%Callable* %6, %Array* %queryRegister)
...
define internal void @Microsoft__Quantum__Canon___cc9918f8954448c191d048b07b6bc3c9_ApplyToEachA__body(%Callable* %singleElementOperation, %Array* %register) {
entry:
  ...
  %0 = call %Range @Microsoft__Quantum__Arrays___cda10d46288f488394e630ed0301114d_IndexRange__body(%Array* %register)
...
define internal void @Microsoft__Quantum__Canon___cc9918f8954448c191d048b07b6bc3c9_ApplyToEachA__adj(%Callable* %singleElementOperation, %Array* %register) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
...
define internal %Array* @Microsoft__Quantum__Arrays___0d57dd9cd09e4096927dde82c89cb683_ForEach__body(%Callable* %action, %Array* %array) {
entry:
...
entry:
  ...
  %1 = call %Array* @Microsoft__Quantum__Arrays___5d12dd7c8c2447d18fd17e83558ffa38_Mapped__body(%Callable* %0, %Array* %input)
  call void @__quantum__rt__array_update_alias_count(%Array* %input, i32 -1)
  call void @__quantum__rt__capture_update_reference_count(%Callable* %0, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %0, i32 -1)
  ret %Array* %1
...
continue__1:                                      ; preds = %entry
  %4 = call %Array* @Microsoft__Quantum__Arrays___0b7fd824a58f44af8463d8a8048b6dc8_Zipped__body(%Array* %pattern, %Array* %queryRegister)
...
define internal %Array* @Microsoft__Quantum__Arrays___0b7fd824a58f44af8463d8a8048b6dc8_Zipped__body(%Array* %left, %Array* %right) {
entry:
...
define internal %Range @Microsoft__Quantum__Arrays___cda10d46288f488394e630ed0301114d_IndexRange__body(%Array* %array) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %array, i32 1)
...
define internal %Array* @Microsoft__Quantum__Arrays___5d12dd7c8c2447d18fd17e83558ffa38_Mapped__body(%Callable* %mapper, %Array* %array) {
entry:
  %retval = alloca %Array*, align 8
