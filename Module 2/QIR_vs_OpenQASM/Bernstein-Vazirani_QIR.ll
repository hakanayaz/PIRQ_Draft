...
@5 = internal constant [17 x i8] c"Measured parity \00"
@6 = internal constant [16 x i8] c", but expected \00"
@7 = internal constant [2 x i8] c".\00"
@8 = internal constant [39 x i8] c"Secret string successfully discovered!\00"
@9 = internal constant [46 x i8] c"`Length(bits)` must be less than 64, but was \00"
@10 = internal constant [33 x i8] c"`bits` must be between 0 and 63 \00"
@11 = internal constant [34 x i8] c"`number` must be between 0 and 2^\00"
@12 = internal constant [15 x i8] c" - 1, but was \00"
...
define internal %Array* @BV__LearnParityViaFourierSampling__body(%Callable* %Uf, i64 %n) {
entry:
  ...
  call void @Microsoft__Quantum__Canon___8a8fe44d4eaf4af38893ee2106820b67_ApplyToEachA__body(%Callable* %0, %Array* %queryRegister)
  ...
  call void @Microsoft__Quantum__Canon___8a8fe44d4eaf4af38893ee2106820b67_ApplyToEachA__adj(%Callable* %5, %Array* %queryRegister)
  ...
  %resultArray = call %Array* @Microsoft__Quantum__Arrays___0a33e7af708347ff9a9d33f96f02dcbb_ForEach__body(%Callable* %6, %Array* %queryRegister)
...
define internal void @Microsoft__Quantum__Canon___8a8fe44d4eaf4af38893ee2106820b67_ApplyToEachA__body(%Callable* %singleElementOperation, %Array* %register) {
entry:
  ...
  %0 = call %Range @Microsoft__Quantum__Arrays___0efebc13f85d459493510e05f9698758_IndexRange__body(%Array* %register)
...
define internal void @Microsoft__Quantum__Canon___8a8fe44d4eaf4af38893ee2106820b67_ApplyToEachA__adj(%Callable* %singleElementOperation, %Array* %register) {
entry:
  call void @__quantum__rt__capture_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %singleElementOperation, i32 1)
  call void @__quantum__rt__array_update_alias_count(%Array* %register, i32 1)
...
define internal %Array* @Microsoft__Quantum__Arrays___0a33e7af708347ff9a9d33f96f02dcbb_ForEach__body(%Callable* %action, %Array* %array) {
entry:
...
entry:
  ...
  %1 = call %Array* @Microsoft__Quantum__Arrays___adb5bba54fdc48fdbed03c08ec875c16_Mapped__body(%Callable* %0, %Array* %input)
  call void @__quantum__rt__array_update_alias_count(%Array* %input, i32 -1)
  call void @__quantum__rt__capture_update_reference_count(%Callable* %0, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %0, i32 -1)
  ret %Array* %1
...
continue__1:                                      ; preds = %entry
  %4 = call %Array* @Microsoft__Quantum__Arrays___2a0b6683727e4c5ba6bc95c760c417b7_Zipped__body(%Array* %pattern, %Array* %queryRegister)
...
define internal %Array* @Microsoft__Quantum__Arrays___2a0b6683727e4c5ba6bc95c760c417b7_Zipped__body(%Array* %left, %Array* %right) {
entry:
...
define internal i64 @BV__RunBernsteinVazirani__body(i64 %nQubits, i64 %patternInt) {
entry:
  ...
  %result = call %Array* @BV__LearnParityViaFourierSampling__body(%Callable* %0, i64 %nQubits)
...
condContinue__1:                                  ; preds = %condTrue__1, %entry
  ...
  %6 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @10, i32 0, i32 0))
...
condContinue__3:                                  ; preds = %condTrue__3, %condContinue__2
  ...
  %14 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @11, i32 0, i32 0))
  ...
  %17 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @12, i32 0, i32 0))
  ...
  %21 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @7, i32 0, i32 0))
  %22 = call %String* @__quantum__rt__string_concatenate(%String* %20, %String* %21)
  call void @__quantum__rt__string_update_reference_count(%String* %20, i32 -1)
  call void @__quantum__rt__string_update_reference_count(%String* %21, i32 -1)
...
entry:
  ...
  %4 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @7, i32 0, i32 0))
...
define internal void @BV__RunProgram__body(i64 %secretString, i64 %nQubits) {
entry:
  %guessedString = call i64 @BV__RunBernsteinVazirani__body(i64 %nQubits, i64 %secretString)
  %0 = icmp ne i64 %guessedString, %secretString
  br i1 %0, label %then0__1, label %continue__1

then0__1:                                         ; preds = %entry
  %1 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @5, i32 0, i32 0))
  %2 = call %String* @__quantum__rt__int_to_string(i64 %guessedString)
  %3 = call %String* @__quantum__rt__string_concatenate(%String* %1, %String* %2)
  call void @__quantum__rt__string_update_reference_count(%String* %1, i32 -1)
  call void @__quantum__rt__string_update_reference_count(%String* %2, i32 -1)
  %4 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @6, i32 0, i32 0))
  %5 = call %String* @__quantum__rt__string_concatenate(%String* %3, %String* %4)
  call void @__quantum__rt__string_update_reference_count(%String* %3, i32 -1)
  call void @__quantum__rt__string_update_reference_count(%String* %4, i32 -1)
  %6 = call %String* @__quantum__rt__int_to_string(i64 %secretString)
  %7 = call %String* @__quantum__rt__string_concatenate(%String* %5, %String* %6)
  call void @__quantum__rt__string_update_reference_count(%String* %5, i32 -1)
  call void @__quantum__rt__string_update_reference_count(%String* %6, i32 -1)
  %8 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @7, i32 0, i32 0))
...
continue__1:                                      ; preds = %entry
  %10 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([39 x i8], [39 x i8]* @8, i32 0, i32 0))
...
define internal %Array* @Microsoft__Quantum__Arrays___adb5bba54fdc48fdbed03c08ec875c16_Mapped__body(%Callable* %mapper, %Array* %array) {
entry:
  %retval = alloca %Array*, align 8
...
define internal %Range @Microsoft__Quantum__Arrays___0efebc13f85d459493510e05f9698758_IndexRange__body(%Array* %array) {
entry:
  call void @__quantum__rt__array_update_alias_count(%Array* %array, i32 1)
...
define void @BV__RunProgram__Interop(i64 %secretString, i64 %nQubits) #1 {
entry:
  call void @BV__RunProgram__body(i64 %secretString, i64 %nQubits)
  ret void
}
...
entry:
  call void @BV__RunProgram__body(i64 %secretString, i64 %nQubits)
  %0 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @13, i32 0, i32 0))
