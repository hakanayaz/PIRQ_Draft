...
define i32 @main(i32 %0, i8** %1) local_unnamed_addr {
  ...
  %4 = tail call i32 @__internal_mlir_bernstein_vazirani2_3()
  tail call void @__quantum__rt__finalize()
  ret i32 0
}

define i32 @__internal_mlir_bernstein_vazirani2_3() local_unnamed_addr {
  %1 = tail call %Array* @__quantum__rt__qubit_allocate_array(i64 20)
  %2 = tail call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %1, i64 8)
  %3 = bitcast i8* %2 to %Qubit**
  %4 = load %Qubit*, %Qubit** %3, align 8
  tail call void @__quantum__qis__u2(double 0.000000e+00, double 0x400921FB54442D18, %Qubit* %4)
  %5 = tail call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %1, i64 3)
  %6 = bitcast i8* %5 to %Qubit**
  %7 = load %Qubit*, %Qubit** %6, align 8
  tail call void @__quantum__qis__cnot(%Qubit* %4, %Qubit* %7)
  %8 = tail call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %1, i64 7)
  %9 = bitcast i8* %8 to %Qubit**
  %10 = load %Qubit*, %Qubit** %9, align 8
  tail call void @__quantum__qis__cnot(%Qubit* %10, %Qubit* %4)
  tail call void @__quantum__qis__cnot(%Qubit* %4, %Qubit* %10)
  %11 = tail call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %1, i64 12)
  %12 = bitcast i8* %11 to %Qubit**
  %13 = load %Qubit*, %Qubit** %12, align 8
  tail call void @__quantum__qis__cnot(%Qubit* %10, %Qubit* %13)
  %14 = tail call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %1, i64 11)
  %15 = bitcast i8* %14 to %Qubit**
  %16 = load %Qubit*, %Qubit** %15, align 8
  tail call void @__quantum__qis__cnot(%Qubit* %16, %Qubit* %13)
  tail call void @__quantum__qis__cnot(%Qubit* %13, %Qubit* %16)
  tail call void @__quantum__qis__cnot(%Qubit* %16, %Qubit* %13)
  tail call void @__quantum__qis__cnot(%Qubit* %10, %Qubit* %13)
  %17 = tail call %Result* @__quantum__qis__mz(%Qubit* %10)
  %18 = tail call %Result* @__quantum__qis__mz(%Qubit* %7)
  %19 = tail call %Result* @__quantum__qis__mz(%Qubit* %16)
  %20 = tail call %Result* @__quantum__qis__mz(%Qubit* %13)
  %21 = tail call %Result* @__quantum__qis__mz(%Qubit* %4)
  tail call void @__quantum__rt__qubit_release_array(%Array* %1)
  ret i32 0
}

define i32 @bernstein_vazirani2_3(%qreg* %0) local_unnamed_addr {
  tail call void @__quantum__rt__set_external_qreg(%qreg* %0)
  %2 = tail call i32 @__internal_mlir_bernstein_vazirani2_3()
  tail call void @__quantum__rt__finalize()
  ret i32 0
}
